      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-[3rem] p-10 md:p-12 shadow-xl shadow-primary/5 border border-stone-100">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-serif font-black text-primary italic mb-3">Welcome Back</h1>
            <p className="text-stone-400 text-sm font-medium">Log in to your artisanal account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-4">
                ...
                <Link to="/forgot-password" size={14} className="text-[10px] font-black uppercase tracking-widest text-primary/40 hover:text-primary transition-colors">Forgot?</Link>
              </div>
              <div className="relative group">
          ...
          <div className="mt-10 text-center">
            <p className="text-stone-400 text-xs font-medium">
              ...
              <Link to="/register" className="text-primary font-black uppercase tracking-widest hover:underline ml-1">Create One</Link>
            </p>
          </div>
        </div>
        
        <div className="mt-8 text-center">
           <Link to="/admin/login" className="text-[10px] font-black uppercase tracking-widest text-stone-300 hover:text-stone-400 transition-colors">
