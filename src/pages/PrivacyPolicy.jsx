        ...
        <div className="bg-white rounded-[3rem] p-12 md:p-16 shadow-xl border border-outline-variant/10">
          ...
          <div className="text-lg text-stone-600 leading-relaxed font-medium italic space-y-6">
            ...
            <ul className="list-disc pl-8 space-y-4">
              <li>
                <strong className="text-primary">Personal Information:</strong> Name, email address, contact details, shipping address, billing information.
              </li>
              <li>
                <strong className="text-primary">Usage Data:</strong> IP address, browser type, browsing history on our site, and other diagnostic data.
              </li>
              <li>
                <strong className="text-primary">Payment Information:</strong> We collect payment details only for the purpose of completing your purchase. All transactions are processed securely by third-party payment providers.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-primary text-secondary-fixed rounded-[2rem] xl:rounded-[3rem] p-8 xl:p-16 shadow-2xl relative overflow-hidden mb-10 xl:mb-20">
          ...
          <div className="text-base xl:text-xl opacity-80 leading-relaxed font-medium italic relative z-10 space-y-4 xl:space-y-6">
            ...
            <div className="space-y-3 xl:space-y-4">
              <p><strong className="text-white">Address:</strong> Nuzvidu, Andhra Pradesh, INDIA, 521202</p>
              <p><strong className="text-white">Email:</strong> dakshacookiesmillets@gmail.com</p>
              <p><strong className="text-white">WhatsApp:</strong> +91 9704254959</p>
            </div>
          </div>
        </div>
