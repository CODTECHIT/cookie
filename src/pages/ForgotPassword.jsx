  ...
  return (
    <>
      <SEO
        ...
        description="Recover your dakshacookiesmillets account securely using your registered email address."
      />
          ...
          <div className="bg-white rounded-[3rem] p-10 md:p-12 shadow-xl shadow-primary/5 border border-stone-100 transition-all duration-500">
            ...
            {step === 3 && (
              <div className="text-center py-6">
                ...
                <h1 className="text-4xl font-serif font-black text-primary italic mb-4">
                  Password Reset!
                </h1>
                <p className="text-stone-400 text-sm font-medium mb-10">
                  Your account is now secure. Please log in with your new
                  credentials.
                </p>
                <Link
                  to="/login"
            ...
            {step !== 3 && (
              <div className="mt-10 text-center">
                <Link
                  to="/login"
                  className="text-stone-400 text-[10px] font-black uppercase tracking-widest hover:text-primary transition-colors"
                >
                  Back to Login
                </Link>
              </div>
