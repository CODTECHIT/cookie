    ...
    return (
      <div className="pt-44 pb-20 px-4 md:px-8 max-w-6xl mx-auto min-h-screen">
        <div className="bg-stone-50 rounded-[3rem] p-12 border border-stone-100 inline-block w-full max-w-md">
          ...
          <Link
            to="/"
            className="block mt-6 text-xs font-bold text-stone-400 uppercase tracking-widest hover:text-primary transition-colors"
          >
            Return to Home
          </Link>
        </div>
        ...
        <div className="mb-12 bg-emerald-50 border border-emerald-100 rounded-[2.5rem] p-8 md:p-10 flex flex-col md:flex-row items-center gap-6 animate-in fade-in slide-in-from-top-4 duration-700">
          ...
          <div className="flex-grow text-center md:text-left">
            ...
            <p className="text-emerald-700/70 font-medium text-sm mt-1">
              Thank you for choosing artisanal quality. Your order is now being
              processed.
            </p>
          </div>
          <button
