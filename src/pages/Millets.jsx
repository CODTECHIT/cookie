...
const FilterContent = ({ 
  ...
  <div className="bg-[#F8F5F0] lg:rounded-3xl p-8 lg:border border-stone-100 h-full overflow-y-auto flex flex-col">
    ...
    {/* Category */}
    <div className="mb-10">
      <h3 className="text-[11px] font-black uppercase tracking-widest text-primary/40 mb-6 font-sans">Type</h3>
      <div className="space-y-4">
        {['Unpolished', 'Millet Mix', 'Ready to Cook', 'Flours'].map(cat => (
...
const Millets = () => {
  ...
  const [selectedCategories, setSelectedCategories] = useState(['Unpolished']);
  const [selectedWeight, setSelectedWeight] = useState('500g');

  const products = useMemo(() => [
    { id: 11, title: "Organic Pearl Millet", price: 145, oldPrice: 199, img: "https://lh3.googleusercontent.com/aida-public/AB6AXuDqaTyoHCDyWZIeGkC_a_Gq-4zmaNubJTZW5n-LKjSWh4I0nmkZxEWmdxLKhlaZGayZK4YAMu559nT29mxngRZvte-UiLq12GpAnf93pAmIeiAIh-nf9-6vW9ZG0JdS-_QbNBSV8K6kity99VIKBnXoVbmBTFSohuHKLJ44r2QlFlqgsJuew7IxcNxqdxjE3NH5CIrpn93osqMuitzDIRlYEJ38n0bXnKTa5rocEDQ-R-oGXn917bbGIWZqfOA8-3c8hcai5o4nDnQ", weight: "1kg", tagline: "Nutrient Rich & Gluten-Free", category: "Unpolished" },
    { id: 12, title: "Foxtail Millet Grains", price: 165, oldPrice: 220, img: "https://lh3.googleusercontent.com/aida-public/AB6AXuDqaTyoHCDyWZIeGkC_a_Gq-4zmaNubJTZW5n-LKjSWh4I0nmkZxEWmdxLKhlaZGayZK4YAMu559nT29mxngRZvte-UiLq12GpAnf93pAmIeiAIh-nf9-6vW9ZG0JdS-_QbNBSV8K6kity99VIKBnXoVbmBTFSohuHKLJ44r2QlFlqgsJuew7IxcNxqdxjE3NH5CIrpn93osqMuitzDIRlYEJ38n0bXnKTa5rocEDQ-R-oGXn917bbGIWZqfOA8-3c8hcai5o4nDnQ", weight: "500g", tagline: "Ancient Smart Food", category: "Unpolished" },
    { id: 13, title: "Kodo Millet Premium", price: 180, oldPrice: 250, img: "https://lh3.googleusercontent.com/aida-public/AB6AXuDqaTyoHCDyWZIeGkC_a_Gq-4zmaNubJTZW5n-LKjSWh4I0nmkZxEWmdxLKhlaZGayZK4YAMu559nT29mxngRZvte-UiLq12GpAnf93pAmIeiAIh-nf9-6vW9ZG0JdS-_QbNBSV8K6kity99VIKBnXoVbmBTFSohuHKLJ44r2QlFlqgsJuew7IxcNxqdxjE3NH5CIrpn93osqMuitzDIRlYEJ38n0bXnKTa5rocEDQ-R-oGXn917bbGIWZqfOA8-3c8hcai5o4nDnQ", weight: "500g", tagline: "Low Glycemic Index", category: "Ready to Cook" },
    { id: 14, title: "Little Millet (Samalu)", price: 155, oldPrice: 210, img: "https://lh3.googleusercontent.com/aida-public/AB6AXuDqaTyoHCDyWZIeGkC_a_Gq-4zmaNubJTZW5n-LKjSWh4I0nmkZxEWmdxLKhlaZGayZK4YAMu559nT29mxngRZvte-UiLq12GpAnf93pAmIeiAIh-nf9-6vW9ZG0JdS-_QbNBSV8K6kity99VIKBnXoVbmBTFSohuHKLJ44r2QlFlqgsJuew7IxcNxqdxjE3NH5CIrpn93osqMuitzDIRlYEJ38n0bXnKTa5rocEDQ-R-oGXn917bbGIWZqfOA8-3c8hcai5o4nDnQ", weight: "500g", tagline: "Magnesium Rich", category: "Millet Mix" },
  ], []);
  ...
  return (
    <div className="pt-16 lg:pt-32 pb-20 px-4 xl:px-10 max-w-[1700px] mx-auto min-h-screen bg-[#FDFBF7]">
      ...
      <nav className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-wider text-stone-400 mb-8 overflow-x-auto whitespace-nowrap hide-scrollbar">
        ...
        <span className="text-stone-900">Premium Millets & Grains</span>
      </nav>
        ...
        <main className="flex-grow">
          ...
          <div className="hidden lg:flex bg-[#F8F5F0] rounded-2xl p-6 mb-10 justify-between items-center border border-stone-100">
            <p className="text-sm font-medium text-stone-500 italic">
              Found <span className="font-bold text-primary not-italic">{filteredProducts.length}</span> nutritious selections
            </p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 xl:grid-cols-3 gap-x-3 gap-y-8 md:gap-x-8 md:gap-y-12">
            {filteredProducts.map(p => (
               <FlipkartCard key={p.id} p={p} category="millets" />
            ))}
          </div>

          {filteredProducts.length === 0 && (
            <div className="text-center py-32 animate-fade-in">
               <span className="material-symbols-outlined text-7xl text-stone-200 mb-6 font-thin">potted_plant</span>
               <h3 className="text-xl font-serif italic text-primary mb-2">No millets found</h3>
               <p className="text-sm text-stone-400 font-medium tracking-wide">Try adjusting your filters to discover our other grains.</p>
