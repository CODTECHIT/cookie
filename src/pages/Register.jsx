      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-[3rem] p-10 md:p-12 shadow-xl shadow-primary/5 border border-stone-100">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-serif font-black text-primary italic mb-3">Create Account</h1>
            <p className="text-stone-400 text-sm font-medium">Join our family of food lovers</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-widest text-stone-400 ml-4">Phone Number</label>
              <div className="relative group">
          ...
          <div className="mt-10 text-center">
            <p className="text-stone-400 text-xs font-medium">
              ...
              <Link to="/login" className="text-primary font-black uppercase tracking-widest hover:underline ml-1">Sign In</Link>
            </p>
          </div>
        </div>
      </div>
