...
import { 
  LayoutDashboard, ShoppingBag, ShoppingCart, Users, CreditCard, 
  Truck, BarChart3, Ticket, Grid, Image, Star, Settings, LogOut, Menu, X, Bell
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-gray-100 flex items-center justify-between px-4 lg:px-8 z-30">
          <button className="lg:hidden p-2 text-gray-500 hover:bg-gray-50 rounded-lg" onClick={toggleSidebar}>
